...
class ScreenCaptureService : Service() {
    ...
    /*
     * Fallback pattern for cases where OCR
     * recognizes the number but misses × or x.
     *
     * Examples:
     *
     * 1.25
    ...
    override fun onStartCommand(
         ...
         * RESULT_OK is -1.
         *
         * Therefore we must check whether
         * the resultCode extra actually exists.
         */
        ...
        /*
         * The MediaProjection permission Intent
    ...
    private fun processImage(
         ...
         *
         * This limits OCR to roughly four
         * attempts per second.
         */
        if (
            now - lastOcrTime <
        ...
        try {
            ...
            /*
             * Use a larger central region than before.
             *
             * Previous:
             * 80% width × 60% height
             *
             ...
             * 90% width × 80% height
             *
             * This gives OCR more opportunity to
             * see the multiplier.
             */
            val cropWidth =
                (
    ...
    private fun runOcr(
        ...
        textRecognizer
            ...
            .addOnSuccessListener { result ->
                ...
                /*
                 * Tell us whether ML Kit actually
                 * recognizes anything on the screen.
                 */
                if (text.isBlank()) {
                ...
                /*
                 * Display the actual OCR text.
                 *
                 * This is intentionally limited to
                 * 180 characters so the diagnostic
                 * message does not become enormous.
                 */
                val diagnosticText =
                    text
                        .replace(
    ...
    private fun extractMultiplier(
         ...
         * STEP 1:
         *
         * Search for a number followed by x.
         */
        val explicitMatcher =
         ...
         * STEP 2:
         *
         * OCR may recognize the multiplier number
         * but miss the × symbol.
         */
        val decimalMatcher =
    ...
    private fun handleMultiplier(
        ...
        /*
         * Broadcast a new live multiplier only
         * when the value changes by at least 0.01.
         */
        if (
